package Metaheuristics.AVOA.Algorithm;

import Metaheuristics.MetaheuristicAlgorithm;
import Metaheuristics.MetaheuristicFitnessFunction;
import utils.Constants;

import java.util.Random;

import static Metaheuristics.AVOA.Algorithm.BoundaryCheck.boundaryCheck;
import static Metaheuristics.AVOA.Algorithm.Exploitation.exploitation;
import static Metaheuristics.AVOA.Algorithm.Exploration.exploration;
import static Metaheuristics.AVOA.Algorithm.Initialization.initialization;
import static Metaheuristics.AVOA.Algorithm.RandomSelection.randomSelect;


public class AVOA implements MetaheuristicAlgorithm {
    ...
    public AVOA() {
        ...
        this.varSize = Constants.NO_OF_TASKS;
