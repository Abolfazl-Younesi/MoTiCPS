...
import Metaheuristics.AVOA.Algorithm.AVOA;
import Metaheuristics.AVOA.Algorithm.SchedulerFitnessFunction;
import Metaheuristics.GEO.GEO;
...
public class AVOAScheduler {

    private static List<Cloudlet> cloudletList;
    private static List<Vm> vmList;
    private static Datacenter[] datacenter;
    private static AVOA AVOASchedulerInstance;
...
//    }
    ...
    public static List<Cloudlet> main(String[] args) {
        Log.printLine("Starting AVOA Scheduler...");
        ...
        try {
            ...
            AVOADatacenterBroker broker = createBroker("Broker_0");
            ...
            Log.printLine(AVOAScheduler.class.getName() + " finished!");
    ...
    private static AVOADatacenterBroker createBroker(String name) throws Exception {
        return new AVOADatacenterBroker(name);
    }
...
//        RSASchedulerInstance.printBestFitness();
        //Added:
